...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between">
      {/* HEADER */}
      <div>
        <div className="flex justify-between items-center mb-2 px-5 pt-2">
      ...
      {/* BODY */}
      <div className="flex items-center mb-6 justify-around gap-4 px-5">
          ...
          {details.map((detail, index) => (
            <React.Fragment key={index}>
              <div className="flex items-center my-4">
                ...
                <span className="font-bold text-gray-800 mr-20">
                  {detail.amount}
                </span>
                <div className="flex items-center">
                  <detail.IconComponent
                    className={`size-4 mr-1 ${changeColor(
